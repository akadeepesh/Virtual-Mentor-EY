    ...
    return (
        <div className='flex my-20 flex-col items-center justify-center max-w-screen-xl w-screen mx-auto'>
            ...
            <div className="mt-12">
                ...
                <Link href='#aboutV' className="bg-primary text-secondary rounded-md py-2 md:mx-2 px-3 md:px-5 cursor-pointer font-medium hover:bg-gray-300 duration-200">Learn More</Link>
            </div>
