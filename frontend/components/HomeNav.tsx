...
const HomeNav = () => {
  ...
  return (
    <header className='flex md:mt-4 justify-between h-20 items-center p-4 md:mx-auto max-w-screen-xl w-screen'>
      ...
      <div className={`${nav ? 'h-[40vh]' : 'h-0'} w-full ${nav ? 'translate-y-16' : '-translate-y-40'} flex md:hidden absolute bg-red-200 justify-center top-0 left-0 items-center ease-in-out duration-300`}><NavigationMenuDemo /></div>
